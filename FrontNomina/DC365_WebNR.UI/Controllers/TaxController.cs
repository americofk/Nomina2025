...
namespace DC365_WebNR.UI.Controllers
{
    ...
    public class TaxController : ControllerBase
    {
        ...
        /// <summary>
        /// Endpoint AJAX para paginacion de impuestos.
        /// </summary>
        [HttpGet("GetTaxesPaged")]
        public async Task<JsonResult> GetTaxesPaged(string searchValue = "", int pageNumber = 1, int pageSize = 20)
        {
            GetdataUser();
            process = new ProcessTax(dataUser[0]);
