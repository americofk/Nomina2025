...
namespace DC365_WebNR.UI.Controllers
{
    ...
    public class LoanController : ControllerBase
    {
        ...
        /// <summary>
        /// Endpoint AJAX para paginacion de prestamos.
        /// </summary>
        [HttpGet("GetLoansPaged")]
        public async Task<JsonResult> GetLoansPaged(string searchValue = "", int pageNumber = 1, int pageSize = 20)
        {
            GetdataUser();
            process = new ProcessLoan(dataUser[0]);
