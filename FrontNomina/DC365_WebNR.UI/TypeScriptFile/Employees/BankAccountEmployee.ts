...
variables: {
    interface IDomElement_Modal {
        ...
        url_help: string //Url de la ayuda
        div_help: string //Contenedor de la ayuda
        url_imagehelp: string //Url de la imagen de la ayuda
    }
...
const fn = {
    ...
    SearchBankAccountsInformation: function (_idEmployee: string) {
        $.ajax({
    ...
    //Buscar para editar
    SearchEmployeeBankAccountId: function (_idEmployee: string, _internalId: string) {
        $.ajax({
