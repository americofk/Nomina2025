...
namespace DC365_WebNR.CORE.Aplication.Services
{
    ...
    public class ProcessDeductionCode: ServiceBase
    {
        ...
        public async Task<IEnumerable<DeductionCode>> GetAllDataAsync(bool _IsVersion = false, string id = "", string PropertyName = "", string PropertyValue = "", int _PageNumber = 1,int PageSize=1500)
        {
        ...
        public async Task<ResponseUI> PostDataAsync(DeductionCode _model)
        {
            ...
            if (Api.IsSuccessStatusCode)
            {
                ...
                else
                {
                    ...
                    responseUI.IdType = DataApi.Data?.DeductionCodeId;
                }
