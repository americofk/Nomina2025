...
using DC365_PayrollHR.Infrastructure;
using DC365_PayrollHR.Core.Application;
...
using DC365_PayrollHR.WebUI.Services;
...
namespace DC365_PayrollHR.WebUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Funci�n que evalua los modelos y envia los mensajes de error customizados
