        ...
        public async Task<PagedResponse<IEnumerable<CourseLocation>>> GetAll(PaginationFilter filter, SearchFilter searchFilter, object queryfilter = null)
        {
                ...
                searchFilter.PropertyName.Contains(","))
            {
                ...
                tempResponse = tempResponse.Where(x =>
                    (x.CourseLocationId != null && x.CourseLocationId.ToLower().Contains(searchValue)) ||
            ...
            var pagedResponse = new PagedResponse<IEnumerable<CourseLocation>>(response, validFilter.PageNumber, validFilter.PageSize);
